...
$addTimestamp
$addSelectMenu[1;string;destekmenu_$authorID;👉 Kategori seç.;1;1;false;Premium:Premium almak istiyorum.:pre:false:💎;Yardım:Yardım almak istiyorum.:yardım:false:⛑️;Diğer:Başka konular hakkında konuşmak istiyorum.:diger:false:📙]
...
{newEmbed:
{title:❌ **Hata!**}
{description:Şu anda **50** yani maksimum canlı destek var. Bir süre sonra tekrar deneyiniz.}
...
{newEmbed:
{title:❌ **Hata!**}
{description:Sunucudaki ayarlanmış metin kanalı silinmiş. Kurulumun tekrar yapılması gerekiyor.}
{color:#E34A51}}{interaction}{ephemeral}]

$onlyIf[$guildChannelExists[$getVar[sunucu];$getVar[yetkilikategori]]!=false;
{newEmbed:
{title:❌ **Hata!**}
{description:Sunucudaki ayarlanmış kategori silinmiş. Kurulumun tekrar yapılması gerekiyor.}
{color:#E34A51}}{interaction}{ephemeral}]
